  ...
  return (
    <section id="download" className="py-28 md:py-36">
      <div className="max-w-[1120px] mx-auto px-6 text-center">
        <ScrollReveal>
          <h2 className="text-foreground text-3xl md:text-[3.5rem] font-bold tracking-[-0.035em] leading-[1.1] text-balance mb-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              disabled
              className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-full bg-foreground/40 text-background text-sm font-semibold cursor-not-allowed"
            >
